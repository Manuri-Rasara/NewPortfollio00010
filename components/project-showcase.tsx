...
export function ProjectShowcase() {
  ...
  return (
    <section ref={containerRef} onMouseMove={handleMouseMove} className="relative w-full mx-auto px-6 py-16">
      <h2 className=" text-6xl font-bold tracking-wide uppercase mb-8 text-black">Selected Work</h2>
