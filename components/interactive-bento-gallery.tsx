...
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems, galleryId }: GalleryModalProps) => {
    ...
    return (
        <>
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-gray-500/20 backdrop-blur-xl 
...
const InteractiveBentoGallery: React.FC<InteractiveBentoGalleryProps> = ({ mediaItems, title}) => {
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 auto-rows-[180px] sm:auto-rows-[60px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                key={item.id}
                                layoutId={`media-${galleryId}-${item.id}`}
