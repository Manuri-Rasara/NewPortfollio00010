...
export function MagneticText({
  ...
  // Animation loop (safe for Next.js)
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Base text */}
      <span className="text-5xl font-bold tracking-wide text-foreground">
        {text}
      </span>
      ...
      >
        ...
        >
          <span className="text-5xl font-bold tracking-wide text-background whitespace-nowrap">
            {hoverText}
          </span>
        </div>
      </div>
