...
const portfolioData = [
  ...
  // },
  {
    ...
    projects: [
      { id: "w1", image: "./Assets/DEV-Portfolio.png" },
      { id: "w2", image: "./Assets/DEV-Thunder-Portfolio.png" },
      { id: "w3", image: "./Assets/App-Mos.png" },
      { id: "w4", image: "./Assets/DEV-Portfolio-Emogi-Color.png"},
  ...
  },
  {
    ...
    projects: [
      { id: "u1", image: "./Assets/App-UI-FOOD-Delivery.png" },
      { id: "u2", image: "./Assets/Logo-Ceylone.png" },
      { id: "u3", image: "./Assets/UI-Blue-Portfolio.png"},
      { id: "u4", image: "./Assets/UI-johndoe-Portfolio-Black.png" },
      { id: "u6", image: "./Assets/Logo-Toast.png" },
      { id: "u5", image: "./Assets/UI-Orange-Portfolio.png" },
  ...
  return (
    <main className="min-h-screen bg-background text-foreground transition-colors duration-500 selection:bg-accent/30 selection:text-accent-foreground">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols- gap-12 justify-items-center">
