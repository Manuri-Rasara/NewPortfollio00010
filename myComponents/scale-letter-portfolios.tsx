...
export default function LetterHoverEffectPortfoliosV1() {
    const [hoveredIndex, setHoveredIndex] = useState<number>(-1);
    const text = "PORTFOLIO V1.0";
    ...
    return (
        <div className=" w-full flex justify-center items-center bg-gradient-to-br dark:from-black/90 dark:to-black from-white/90 to-white transition-colors duration-500">
            <div className="text-4xl font-medium select-none text-black dark:text-white">
